...
function convert(word) {
    if (word === "paper") return '<i class="fa-regular fa-hand fa-flip"></i>';
    if (word === "rock") return '<i class="fa-regular fa-hand-back-fist fa-flip"></i>';
    return '<i class="far fa-hand-scissors fa-flip"></i>'
}
